...
## Description
This is a simple Java username and password generator that was generated by OpenAI's ChatGPT (version 3.5) Large Language Model (LLM). [Here](https://github.com/JaspreetKhela/ai-assisted-software-design-exercise/blob/main/AI-Assisted%20Software%20Design%20Exercise%20-%20ChatGPT%20Prompts%20and%20Answers.pdf) is a PDF file containing the ChatGPT prompts and responses that were used to generate this program.
